...
public class UmsRoleController {
    ...
    @ResponseBody
    public CommonResult<List<UmsRole>> listAll(HttpServletRequest request) {
        List<UmsRole> roleList = roleService.list(request);
    ...
    public CommonResult<CommonPage<UmsRole>> list(@RequestParam(value = "keyword", required = false) String keyword,
        ...
        List<UmsRole> roleList = roleService.list(keyword, pageSize, pageNum, request);
