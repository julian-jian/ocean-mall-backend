 ...
 */
@Controller
@Api(tags = "SmsHomeAdvertiseController", description = "首页轮播图管理")
...
public class SmsHomeAdvertiseController {
    ...
    public CommonResult<CommonPage<SmsHomeAdvertise>> list(@RequestParam(value = "name", required = false) String name,
        ...
        List<SmsHomeAdvertise> advertiseList = advertiseService.list(name, type, updateTime, pageSize, pageNum);
