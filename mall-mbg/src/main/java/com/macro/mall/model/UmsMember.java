...
public class UmsMember implements Serializable {
    ...
    @ApiModelProperty(value = "历史消费，主要和段位相关，每月减少一个段位")
    private BigDecimal historyConsumption;

    @ApiModelProperty(value = "本月消费，每月清空一次")
    ...
    public BigDecimal getHistoryConsumption() {
        return historyConsumption;
    }

    public void setHistoryConsumption(BigDecimal historyConsumption) {
        this.historyConsumption = historyConsumption;
    }

    public BigDecimal getCurrentMonthConsumption() {
        return currentMonthConsumption;
    }

    public void setCurrentMonthConsumption(BigDecimal currentMonthConsumption) {
