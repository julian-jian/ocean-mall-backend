...
import com.macro.mall.resource.ExpressResource;
...
public class YiYuanServiceImpl implements YiYuanService {
    @Autowired
    ExpressResource expressResource;
    ...
    public ExpressBean searchExpress(String expressNumber, String phone) throws NoSuchAlgorithmException, InvalidKeyException, UnsupportedEncodingException {
        //云市场分配的密钥Id
        String secretId = expressResource.getSecretId();
        //云市场分配的密钥Key
        String secretKey = expressResource.getSecretKey();
        ...
        queryParams.put("com", "auto");
        queryParams.put("nu", expressNumber);
        ...
        try {
            ...
            ExpressBean express = JSONObject.parseObject(result, ExpressBean.class);
            return express;
        } catch (Exception e) {
