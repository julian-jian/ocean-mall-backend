...
public class OmsCartItemController {
    ...
    @ApiOperation("判断某个商品是否存在于购物车中")
    @RequestMapping(value = "/existStatus/{productId}", method = RequestMethod.GET)
    @ResponseBody
    public CommonResult<CartExist> existStatus(@PathVariable Long productId) {
        CartExist exist = cartItemService.getExist(productId);
